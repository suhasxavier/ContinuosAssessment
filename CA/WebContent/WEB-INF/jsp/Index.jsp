...
<script type="text/html"><h3> Team Activity </h3></script>
...
function getProjectInfo(projectName){
	...
	$.ajax({
        ...
        success: function(data){
        	...
        	if (data[1][8]==0)
        		{
        		alert("This team has no Scrumwise data for Sprint 4 ");
        		}
        	//alert(data);
        	else{
        	//alert(data[0]);
...
//alert('Posting Id entered = ' + posting_id);
	...
	$.ajax({
        ...
        success: function(data)
        {
        	...
        	if (len==undefined)
        		{
        		alert ("This posting id is not recognized, please try again with a correct one")
        		}
        	else{
        	//alert(data);	
          ...
          var legend = svg.append("g")
        	...
        	error:function (xhr, ajaxOptions, thrownError) {
                alert("Sorry  that posting id is not recognized");
                //alert(thrownError);
              } 
    			}); 
...
<select id="projOptions" class="dropdown" name="name"  onchange="getProjectInfo(this)">
...
<br />
<p> Enter Posting Id and click Submit to retrieve individual details </p>
<input type="text" class="inputs" id = "posting_id" placeholder="Posting Id" /> 
